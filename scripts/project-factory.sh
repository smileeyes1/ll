...
for f in README.md SPEC.md STATE.md DECISIONS.md CAPABILITIES.md EVIDENCE.md RUNBOOK.md; do cp "templates/PROJECT/$f" "$ROOT/$f"; done
sed -i "s/{{PROJECT_NAME}}/$NAME/g; s/{{GOAL}}/$GOAL/g" "$ROOT"/README.md "$ROOT"/SPEC.md
